...
class Game(Frame):
 ...
 # create the rooms and give them meaningful names 
        r1 = Room("Room 1", 'bonfire.gif') 
        r2 = Room("Room 2", 'fireplace') 
        r3 = Room("Room 3", 'tv.gif') 
        r4 = Room("Room 4", 'beer.gif') 
        r5 = Room("Room 5", 'key.gif')
        r6 = Room("Room 6", 'yhorm.gif')
    ...
    # add items to room 1 
        ...
        r1.addItem("bonfire", "There seems to be some kind of sword sticking out of it. \nIs it useable?")
...
#apologies for not adding much i was mega focusing on learning C++